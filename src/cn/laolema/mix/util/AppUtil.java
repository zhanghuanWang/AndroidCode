...
public class AppUtil {
	 ...
	 * 描述：创建桌面快捷方式
	 * @param context
	 * @param shortcutName,应用图标名字
	 * @param resId  应用图标
	 * 需要权限<uses-permission android:name="com.android.launcher.permission.INSTALL_SHORTCUT" />
	 */
	public static void createShortcut(Context context, String shortcutName, int resId) {
	 ...
	 * 描述：用来判断服务是否运行.
	 * @param context the context
	 * @param className 判断的服务名字 服务包名"com.xxx.xx..XXXService"
